...
from x_ray_webhook.configuration import Configuration
from x_ray_webhook.api_response import ApiResponse, T as ApiResponseT
import x_ray_webhook.models
from x_ray_webhook import rest
from x_ray_webhook.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(x_ray_webhook.models, klass)
