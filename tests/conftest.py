...
def client(request: FixtureRequest) -> Iterator[XRayWebhook]:
    ...
    with XRayWebhook(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
...
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncXRayWebhook]:
    ...
    async with AsyncXRayWebhook(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
